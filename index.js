...
//
const BotName = 'DIKA BOT 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/endkm.tm'; // Nama Instagramlu cok
const whatsapplu = '0895-4129-70859'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam Non-Stop!'; // Kapan bot lu aktif
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @endkm.tm`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @endkm.tm`)
})
